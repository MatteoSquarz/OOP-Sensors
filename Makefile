...
distdir: FORCE
	...
	$(COPY_FILE) --parents AbstractSensor.h LuminositySensor.h MotionSensor.h SensorContainer.h SensorObserverInterface.h SensorVisitorInterface.h TemperatureSensor.h Json/JsonFile.h Json/Reader.h Json/SensorJsonVisitor.h View/ApplicationPanel.h View/ChartPanel.h View/Info.h View/InfoPanel.h View/InsertWindow.h View/MainWindow.h View/ModifyWindow.h View/ModifyWindowVisitor.h View/SearchPanel.h View/SensorChartVisitor.h View/SensorInfoVisitor.h View/SensorPanel.h $(DISTDIR)/
	$(COPY_FILE) --parents AbstractSensor.cpp LuminositySensor.cpp main.cpp MotionSensor.cpp SensorContainer.cpp TemperatureSensor.cpp Json/JsonFile.cpp Json/Reader.cpp Json/SensorJsonVisitor.cpp View/ApplicationPanel.cpp View/ChartPanel.cpp View/Info.cpp View/InfoPanel.cpp View/InsertWindow.cpp View/MainWindow.cpp View/ModifyWindow.cpp View/ModifyWindowVisitor.cpp View/SearchPanel.cpp View/SensorChartVisitor.cpp View/SensorInfoVisitor.cpp View/SensorPanel.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_ApplicationPanel.cpp moc_ChartPanel.cpp moc_Info.cpp moc_InfoPanel.cpp moc_InsertWindow.cpp moc_MainWindow.cpp moc_ModifyWindow.cpp moc_SearchPanel.cpp moc_SensorPanel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ApplicationPanel.cpp moc_ChartPanel.cpp moc_Info.cpp moc_InfoPanel.cpp moc_InsertWindow.cpp moc_MainWindow.cpp moc_ModifyWindow.cpp moc_SearchPanel.cpp moc_SensorPanel.cpp
...
moc_ModifyWindow.cpp: View/ModifyWindow.h \
		AbstractSensor.h \
		SensorVisitorInterface.h \
		SensorObserverInterface.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/student/Documents/GitHub/OOP-Sensors/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/student/Documents/GitHub/OOP-Sensors -I/home/student/Documents/GitHub/OOP-Sensors -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtCharts -I/usr/include/x86_64-linux-gnu/qt6/QtOpenGLWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtOpenGL -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include View/ModifyWindow.h -o moc_ModifyWindow.cpp
...
SensorContainer.o: SensorContainer.cpp SensorContainer.h \
		AbstractSensor.h \
		SensorVisitorInterface.h \
		SensorObserverInterface.h \
		TemperatureSensor.h \
		MotionSensor.h \
		LuminositySensor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SensorContainer.o SensorContainer.cpp
...
JsonFile.o: Json/JsonFile.cpp Json/JsonFile.h \
		AbstractSensor.h \
		SensorVisitorInterface.h \
		SensorObserverInterface.h \
		Json/SensorJsonVisitor.h \
		Json/Reader.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o JsonFile.o Json/JsonFile.cpp

Reader.o: Json/Reader.cpp Json/Reader.h \
		AbstractSensor.h \
		SensorVisitorInterface.h \
		SensorObserverInterface.h \
		LuminositySensor.h \
		MotionSensor.h \
		TemperatureSensor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Reader.o Json/Reader.cpp

SensorJsonVisitor.o: Json/SensorJsonVisitor.cpp Json/SensorJsonVisitor.h \
		SensorVisitorInterface.h \
		LuminositySensor.h \
		AbstractSensor.h \
		SensorObserverInterface.h \
		MotionSensor.h \
		TemperatureSensor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SensorJsonVisitor.o Json/SensorJsonVisitor.cpp
...
ModifyWindow.o: View/ModifyWindow.cpp View/ModifyWindow.h \
		AbstractSensor.h \
		SensorVisitorInterface.h \
		SensorObserverInterface.h \
		View/ModifyWindowVisitor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ModifyWindow.o View/ModifyWindow.cpp

ModifyWindowVisitor.o: View/ModifyWindowVisitor.cpp View/ModifyWindowVisitor.h \
		SensorVisitorInterface.h \
		TemperatureSensor.h \
		AbstractSensor.h \
		SensorObserverInterface.h \
		MotionSensor.h \
		LuminositySensor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ModifyWindowVisitor.o View/ModifyWindowVisitor.cpp
...
moc_ModifyWindow.o: moc_ModifyWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ModifyWindow.o moc_ModifyWindow.cpp
