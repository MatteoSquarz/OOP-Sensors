...
distdir: FORCE
	...
	$(COPY_FILE) --parents AbstractSensor.h SensorObserverInterface.h SensorVisitorInterface.h TemperatureSensor.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp AbstractSensor.cpp TemperatureSensor.cpp $(DISTDIR)/
